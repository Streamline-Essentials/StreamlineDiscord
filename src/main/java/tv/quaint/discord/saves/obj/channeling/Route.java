...
import tv.quaint.events.DiscordRouteCreateEventSure;
...
public class Route extends SavableResource {
    ...
    public String getMutatedMessage(RoutedUser user, String message, EndPoint endPoint) {
        ...
        StreamlineUser u = ModuleUtils.getOrGetUser(DiscordModule.getVerifiedUsers().getUUIDfromDiscordID(user.getDiscordId()));
